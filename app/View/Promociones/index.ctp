<div class="promociones index">
	...
	<tr>
		...
		<td><?php echo h($promocione['Promocione']['fecha_inicio']); ?>&nbsp;</td>
		<td><?php echo h($promocione['Promocione']['fecha_fin']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $promocione['Promocione']['id']), array(), __('Are you sure you want to delete # %s?', $promocione['Promocione']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
