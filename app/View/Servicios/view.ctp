...
<h2><?php echo __('Servicio'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($servicio['Servicio']['tipo']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Servicio'), array('action' => 'delete', $servicio['Servicio']['id']), array(), __('Are you sure you want to delete # %s?', $servicio['Servicio']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($servicio['Restaurante'])): ?>
	...
	<?php foreach ($servicio['Restaurante'] as $restaurante): ?>
		<tr>
