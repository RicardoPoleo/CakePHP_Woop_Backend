...
<?php echo $this->Form->create('Plane'); ?>
	<fieldset>
		<legend><?php echo __('Edit Plane'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Plane.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Plane.id'))); ?></li>
