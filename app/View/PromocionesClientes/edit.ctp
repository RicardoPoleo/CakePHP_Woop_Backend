...
<?php echo $this->Form->create('PromocionesCliente'); ?>
	<fieldset>
		<legend><?php echo __('Edit Promociones Cliente'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PromocionesCliente.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('PromocionesCliente.id'))); ?></li>
