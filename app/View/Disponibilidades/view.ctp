...
<h2><?php echo __('Disponibilidade'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($disponibilidade['Disponibilidade']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Horario'); ?></dt>
		<dd>
			<?php echo h($disponibilidade['Disponibilidade']['horario']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Disponibilidade'), array('action' => 'edit', $disponibilidade['Disponibilidade']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Disponibilidade'), array('action' => 'delete', $disponibilidade['Disponibilidade']['id']), array(), __('Are you sure you want to delete # %s?', $disponibilidade['Disponibilidade']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Disponibilidades'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Disponibilidade'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($disponibilidade['Restaurante'])): ?>
	...
	<?php foreach ($disponibilidade['Restaurante'] as $restaurante): ?>
		<tr>
